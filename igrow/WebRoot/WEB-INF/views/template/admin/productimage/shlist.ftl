<script type="text/javascript">
    ...
    function searchForminner(){
        ...
        var url = "${contextPath}/admin/productimage/shlist.do?supplier.id="+${(supplier.id)!}+"&pager.pageNumber="+$("#pageNumberinner").val()+"&pager.pageSize="+$("#pageSizeinner").val()+"&searchHotelPro.name="+searchHotelProName+"&searchHotelPro.isAdd="+$("#hotelAddproduproductimage).val();
                ...
                <div class="OrderTable">
                    ...
                    <div class="OrderBottom">
                        ...
                        <tr>
                                ...
                                <th width="81"><span class="empty15">佣金率</span></th>
