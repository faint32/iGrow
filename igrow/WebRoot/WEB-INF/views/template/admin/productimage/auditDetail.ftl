   ...
   $(function(){
		...
		catch(e)
		{
      	...
      	$(".n_calculators input").bind("keyup", function(){
			...
			var _valAfter = _val3.toFixed(10);
			if( _val1 == 0 || _val2 == 0){
	      ...
	      if(window.confirm(alertStr)){
              var formParam={
		         ...
		         "search.auditReason":auditReason
		       	...
		       	$.ajax({    
		                  type:'POST',        
		                  url:'${contextPath}/admin/productimage/auditSave.do',    
		                  data:formParam,    
		                  cache:false,    
		                  dataType:'json',
		                  type:'post',    
	  ...
	  <div class="OrderTable">
                	...
                	<div class="products-vesting">
                    	<ul>
                            ...
                            <li><label class="fixed-width">平台佣金</label><span>${(result.defSysCommRate)!0}%</span></li>
                            <li><label class="fixed-width">酒店佣金</label><span>${(result.defHotelCommRate)!0}%</span></li>
